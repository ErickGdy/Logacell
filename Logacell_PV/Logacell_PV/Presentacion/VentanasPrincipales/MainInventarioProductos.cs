    ...
    public partial class MainInventarioProductos : Form
    {
        ...
        private void actualizarTablaProductos(MySqlDataAdapter data)
        {
            try
            {
                ...
                dataGridViewProductos.Columns[1].Width = 135;
                dataGridViewProductos.Columns[2].Width = 175;
                dataGridViewProductos.Columns[3].Width = 120;
                dataGridViewProductos.Columns[4].Width = 130;
                dataGridViewProductos.Columns[5].Width = 100;
        ...
        {
            FormProducto fp = new FormProducto(null);
        ...
        private void menuModificarProducto_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FormProducto fp = new FormProducto(producto);
                fp.FormClosed += new FormClosedEventHandler(form_Closed);
                fp.Show();
            }
            catch (Exception ex)
